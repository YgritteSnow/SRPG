...
struct WindowImpl : public Window
{
	...
	WindowImpl(wstring title, Size<uint32, 2> size) :
		name_(move(title)), fullScreen_(false),
...
inline void Window::SetMessageIdle(std::function<void()> const & messageIdle)
{
	auto thiz = static_cast<WindowImpl*>(this);
...
inline Size2UI Window::GetClientRegionSize() const
{
	auto thiz = static_cast<WindowImpl const*>(this);
...
inline Size2SI Window::GetWindowPosition() const
{
	auto thiz = static_cast<WindowImpl const*>(this);
